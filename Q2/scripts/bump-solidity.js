...
// [assignment] add your own scripts below to modify the other verifier contracts you will build during the assignmentlet content3 = fs.readFileSync("./contracts/Multiplier3Verifier.sol", { encoding: 'utf-8' });
