...
snarkjs plonk setup _plonkMultiplier3/Multiplier3.r1cs powersOfTau28_hez_final_10.ptau _plonkMultiplier3/circuit_last.zkey
...
snarkjs zkey export solidityverifier _plonkMultiplier3/circuit_last.zkey ../_plonkMultiplier3Verifier.sol
